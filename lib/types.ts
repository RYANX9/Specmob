export type ChipsetTier = { id: string; label: string } | null
...
// GET /phones/slugs — the lightweight list the sitemap is built from.
export interface PhoneSlugRow {
  id: number
  slug: string | null
  brand: string
  model_name: string
...
export interface FeedbackRequest {
  ...
  email?: string
  page_url?: string
  website?: string // honeypot — always left empty by real users
}
