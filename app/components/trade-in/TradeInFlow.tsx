...
import type { Phone, TradeInRequest } from '@/lib/types'
// IMPORTANT: this PhoneVariant is the shape actually returned by
// GET /phones/{id}/variants — { id, ram_gb, storage_gb, price, url }.
// Do NOT import PhoneVariant from '@/lib/types' here — that one models a
// different DB row shape (price_usd) and does not match this endpoint's
// response. Importing the wrong one is what silently produced "Price TBA"
// on every variant card.
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ fontSize: 12, color: c.text3, marginTop: 2 }}>
          {phone.brand}
          {variant
            ? ` · ${variant.storage_gb}GB · ${formatPrice(variant.price)}`
