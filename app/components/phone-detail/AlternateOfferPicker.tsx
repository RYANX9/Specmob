...
export default function AlternateOfferPicker({ offers, phone }: { offers: RetailerOffer[]; phone: { id: number; brand: string; model_name: string } }) {
