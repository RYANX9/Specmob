...
function H2({ id, children }: { id: string; children: React.ReactNode }) {
  return (
    <h2 id={id} style={{
      ...
      marginBottom: 14, scrollMarginTop: 'calc(var(--nav-h) + 20px)', fontWeight: 400
    }}>
      {children}
    </h2>
  )
    ...
    <div style={{ minHeight: '100vh', background: '#F8F6F0' }}>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 var(--page-px) 80px' }}>
        ...
        <div style={{ padding: '36px 0 40px', maxWidth: 720 }}>
          <h1 style={{ fontFamily: f.serif, fontSize: 'clamp(32px,4vw,46px)', color: c.text1, letterSpacing: '-0.5px', marginBottom: 12, fontWeight: 400 }}>
            Privacy Policy
          </h1>
        ...
        <div className="legal-grid" style={{ display: 'grid', gridTemplateColumns: '200px 1fr', gap: 56, alignItems: 'start' }}>
          ...
          <div style={{ maxWidth: 720, background: '#FFFFFF', padding: '32px 36px', borderRadius: r.xl, border: `1px solid ${c.border}` }}>
      ...
      <style>{`
        .legal-toc a:hover { border-left-color: ${c.accent} !important; color: ${c.text1} !important; background: #FFFFFF; }
        ${mq.lg} {
